...
public class TAFReader
{
    ...
    private static void addTimesToList(ArrayList<TimeSchedule> prefTimes, String startTime,String endTime)
    {
        ...
        char[] start = startTime.toArray();
        char[] end = endTime.toArray();
        int startHour = Integer.parseInt(start[0]+start[1]);
        int startMinute = Integer.parseInt(start[2]+start[3]);
        int endHour = Integer.parseInt(end[0]+end[1]);
        int endMinute = Integer.parseInt(end[2]+end[3]);
        /*
