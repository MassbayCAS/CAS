...
public class FileSelectorWindow {
    ...
    private final String WORK_LIST = "workAreas1." + WORK_EXTENSION;
    private final String COURSE_LIST = "CourseSchedule1." + COURSE_EXTENSION;
    private final String TAF_LIST = "TAF_simple1." + TAF_EXTENSION;
    private final String SENIORITY_LIST = "FakeSeniority1." + SENIORITY_EXTENSION;
